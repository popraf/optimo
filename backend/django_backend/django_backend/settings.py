...
DEBUG = True if os.getenv('DJANGO_DEBUG_BOOL') == 'True' else False

ALLOWED_HOSTS = ['*']  # TODO: Change during Prod
...
MIDDLEWARE = [
    ...
    # 'services.aes_encryption.DecryptJWTMiddleware',
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'static_media/')  # dev purposes
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Library Management Simple API',
